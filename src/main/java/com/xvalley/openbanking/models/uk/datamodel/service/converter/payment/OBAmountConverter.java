...
public class OBAmountConverter {
    ...
    public static com.xvalley.openbanking.models.uk.datamodel.account.OBActiveOrHistoricCurrencyAndAmount toAccountOBActiveOrHistoricCurrencyAndAmount(OBWriteDomestic2DataInitiationInstructedAmount amount) {
        return toAmount(new com.xvalley.openbanking.models.uk.datamodel.account.OBActiveOrHistoricCurrencyAndAmount(), amount);
    }
